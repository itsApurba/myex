(function () {
  var quotes = [
    ...
    {
      quote:
        "It's a lack of faith that makes people afraid of meeting challengs, and I believed in myself.",
      author: "Muhammad Ali",
    },
    {
      quote:
    ...
    {
      quote: "I play to win, whether during practice or a real game.",
    ...
    {
      quote: "I don't know where I'm going, but I'm on my way.",
      author: "Carl Sagan",
    },
    {
      quote:
    ...
    {
      quote: "Stop waiting for things to happen and instead make them happen.",
      author: "",
    },
    {
      quote:
    ...
    {
      quote: "It's not knowing what to do, it's doing what you know.",
      author: "Tony Robbins",
    },
    {
    ...
    {
      quote: "Limit everything to the essential but do not remove the poetry",
      author: "Dieter Rams",
    },
    {
      quote: "There's a way to do it better &ndash; find it.",
    ...
    {
      quote: "There are 1,000 lessons in defeat, but only one in victory",
      author: "Confucious",
    },
    {
      quote:
    ...
    {
      quote:
        "Intelligence plus character &ndash; that is the goal of true education.",
  ...
  window.onload = function () {
    ...
    document.getElementById("ss").innerHTML = "hi";
    if (randomQuote.author)
      document.getElementsByTagName("author")[0].innerHTML =
        "&mdash; " + randomQuote.author + " &mdash;";
